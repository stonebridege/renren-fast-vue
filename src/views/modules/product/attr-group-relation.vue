...
export default {
  ...
  methods: {
    ...
    batchDeleteRelation(val) {
      ...
      this.$http({
        url: this.$http.adornUrl("/mallproduct/attrgroup/attr/relation/delete"),
        method: "post",
    ...
    submitAddRealtion() {
      ...
      if (this.innerdataListSelections.length > 0) {
        ...
        this.$http({
          url: this.$http.adornUrl("/mallproduct/attrgroup/attr/relation"),
          method: "post",
          data: this.$http.adornData(postData, false)
        }).then(({ data }) => {
          if (data.code == 0) {
    ...
    init(id) {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/mallproduct/attrgroup/" + this.attrGroupId + "/attr/relation"
        ),
        method: "get",
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl(
          "/mallproduct/attrgroup/" + this.attrGroupId + "/noattr/relation"
        ),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
